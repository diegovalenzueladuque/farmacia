	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-6 mt-3">
				...
				<?php if(isset($_GET['m'])): ?>
					<p class="alert alert-success">El medio de pago se ha registrado correctamente</p>
				<?php endif; ?>
				...
				<?php if(isset($res) && count($res)): ?>
					<table class="table table-hover" style="margin-top: 8px">
						<?php foreach($res as $r): ?>
							<tr>
								<td>
									<a href="verMedPagos.php?id=<?php echo $r['id']; ?>"><?php echo $r['nombre']; ?></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
